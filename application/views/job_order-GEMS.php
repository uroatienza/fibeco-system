...
<body onLoad="pop_category(); update_load_order();">
	...
	<table >
		...
		<tr>
			...
			<tr>
				...
				<input type="checkbox" onChange="update_load_order()" id="all_orders" value="show"><font size="1">Display Cancelled Job Order/s</font>
...
<!-- Modal -->
  ...
  <!-- Testing table -->
<div ng-app="app-job-order" ng-controller="job_controller" >
...
<!-- <div ng-app="ctrlApp" ng-controller="ctrl" >
...
<script>
	...
	function update_load_order(){	
		...
		var app = angular.module('app-job-order', []);
		alert(url);
		app.controller('job_controller', function($scope, $http) {
			$scope.list_data=[];
			$http.get(url).then(function(response) {$scope.list_data=response.data;
			});
		});
</script>
