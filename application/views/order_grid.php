		...
		?>
                 ...
                 <tr>
                  ...
                  <td><a href='#' onClick="pushUpdate('<?php echo $str; ?>')" title="<?php echo $row->orderstatus; ?>"><?php if(strcmp($row->orderstatus,"IN PROGRESS")==0){echo "<span class='glyphicon glyphicon-repeat'></span>";}
